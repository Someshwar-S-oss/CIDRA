...
start cmd /k "%CONDA_PATH%\condabin\conda.bat activate hackathon_env && cd frontend && npm run dev"

:: Activate Miniconda in another new command window for the backend
start cmd /k "%CONDA_PATH%\condabin\conda.bat activate hackathon_env && cd backend && python app.py"
